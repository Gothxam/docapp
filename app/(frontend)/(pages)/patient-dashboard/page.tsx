                ...
                {upcomingAppointments.map((appt, idx) => (
                  <div key={idx} className="bg-muted/50 hover:bg-muted rounded-lg p-4 transition border border-border/50 shadow-xs dark:shadow-none">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <span className="inline-block px-3 py-1 bg-yellow-100 text-yellow-800 dark:bg-yellow-500/20 dark:text-yellow-300 rounded-full text-xs font-semibold flex-shrink-0">
                        Pending
                      </span>
                    </div>
                  </div>
